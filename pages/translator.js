...
export default function Translate() {
  ...
  return (
    <div className='notranslate'>
      ...
      <div className="icon-con" onClick={() => {
         startTranslate() 
         console.log("hello")
         }}><motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.7 }} className='new-icon'><Icon icon="ic:outline-translate" width="24" height="24" style={{ color: '#981FC0' }} /></motion.div><p style={{ fontSize: '10px', fontWeight: '200' }}>Translate</p></div>
