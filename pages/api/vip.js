...
// console.log(users.totald)
        ...
        res.status(200).json({ status: 'success',refCount:refCount,viplevel:viplevel,rprogress:rprogress.toFixed(2),cprogress:cprogress.toFixed(2),c1:parseFloat(c1),r1:parseFloat(r1) })
