    ...
    return(
        <div className="backgrounds" >
            <Stack justifyContent='center' alignItems="center" direction="column" spacing={2} sx={{ minHeight:'98vh',width:'100%'}}>
                ...
                <p className='text-md text-sheffield-red-deep'>Bind Wallet Success</p>
                <p className='text-sm text-grey-500'>Your USDT wallet has been linked to your account successfully</p>
            <motion.p onClick={() => {
