    ...
    return(
        <div className="backgrounds" >
            <Stack justifyContent='center' alignItems="center" direction="column" spacing={2} sx={{ minHeight:'98vh',width:'100%'}}>
                ...
                <Casing className='text-md text-sheffield-red-deep'>Bind Wallet Success</Casing>
                <Casing className='text-sm text-grey-500'>Your USDT wallet has been linked to your account successfully</Casing>
            <motion.p onClick={() => {
