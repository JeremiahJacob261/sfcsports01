      ...
      return (
         <div className="main-account">
            ...
            <div className='new-concept'>
               ...
               <div className="icon-con"><motion.div onClick={() => { handleToggle('/dashboard/transfer') }} whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.7 }} className='new-icon'><Icon icon="tdesign:undertake-transaction" width="24" height="24" style={{ color: '#981FC0' }} /></motion.div><p style={{ fontSize:'10px',fontWeight:'200'}}>transfer</p></div>
               <div className="icon-con"><motion.div onClick={() => { handleToggle('/dashboard/codesetting') }} whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.7 }} className='new-icon'><Icon icon="carbon:security" width="24" height="24" style={{ color: '#981FC0' }} /></motion.div><p style={{ fontSize:'10px',fontWeight:'200'}}>transaction pin</p></div>
               <div className="icon-con"><motion.div onClick={() => { handleToggle('/dashboard/changepassword') }} whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.7 }} className='new-icon'><Icon icon="tabler:password-fingerprint" width="24" height="24" style={{ color: '#981FC0' }} /></motion.div><p style={{ fontSize:'10px',fontWeight:'200'}}>login password</p></div>
